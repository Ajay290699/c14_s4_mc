...
//        this.user = new User(111,"Rakesh",4829895219l,product);
//        mockMvc = MockMvcBuilders.standaloneSetup(customerController).build();
//    }
//
//    @Test
//    public void givenCustomerToSaveReturnSavedCustomer() throws Exception {
//        when(customerService.addCustomer(any())).thenReturn(user);
...
//        String result="user deleted succefully";
//        when(customerService.deleteCustomer(anyInt())).thenReturn(result);
//        mockMvc.perform(delete("/api/v1/user/1002")
//                .contentType(MediaType.APPLICATION_JSON)
